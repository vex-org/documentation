...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/tour', redirect: { name: 'Playground' } },
    { path: '/playground', name: 'Playground', component: () => import('../views/PlaygroundView.vue'), meta: { title: 'Playground', description: 'Learn Vex step by step in an interactive playground — guided lessons, live execution, and no installation required.' } },
    ...
    { path: '/download', name: 'Download', component: () => import('../views/DownloadView.vue'), meta: { title: 'Download', description: 'Install the Vex compiler with a single command. Linux and macOS support.' } },
