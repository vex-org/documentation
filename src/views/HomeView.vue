...
const codeExample = `fn main(): i32 {
    ...
    let sum = data.iter().fold(0, fn(a: i64, b: i64): i64 { a + b });
      ...
      <div class="relative max-w-6xl mx-auto px-4 sm:px-6 pt-20 pb-16 sm:pt-28 sm:pb-24">
        <div class="text-center max-w-3xl mx-auto">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            <router-link to="/docs/guide/introduction" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-vex-primary hover:bg-vex-primary-light text-white font-medium transition-all shadow-lg shadow-vex-primary/25 hover:shadow-vex-primary/40">
              Get Started
    ...
    <section class="border-t border-vex-border">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 py-20 text-center">
        ...
        <div class="flex items-center justify-center gap-3">
          <router-link to="/docs/guide/installation" class="px-6 py-3 rounded-xl bg-vex-primary hover:bg-vex-primary-light text-white font-medium transition-all">Install Vex</router-link>
