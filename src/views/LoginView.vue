...
<template>
  <div class="min-h-[60vh] flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      ...
      <div class="space-y-3">
        <button type="button" :disabled="!!loading" class="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-vex-border bg-vex-surface hover:bg-vex-surface-light text-white font-medium transition-all cursor-pointer disabled:opacity-50" @click="signInWith('github')">
        ...
        <button type="button" :disabled="!!loading" class="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-vex-border bg-vex-surface hover:bg-vex-surface-light text-white font-medium transition-all cursor-pointer disabled:opacity-50" @click="signInWith('google')">
